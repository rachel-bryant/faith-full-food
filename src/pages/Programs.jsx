...
function Programs() {
    ...
    return (
        ...
        <div className="people-section">
            <Person photo="../public/images/headshots/Jon.jpg" name="Jon Shockness" description="Jon Shockness is a creative artist known by the names Neon Wolf and Kid Astronaut. He is also the founder of GARDEN, a mobile food pantry focused on advancing food justice by delivering food directly to places where people already gather." podcast="../public/audio/jon_podcast.mp3" podcast2="../public/audio/jon_podcast_2.mp3" className="orange-person"/>
            <Person photo="../public/images/headshots/Bethany.png" name="Bethany Hader Crabbs" description="Bethany Hader Crabbs serves as the Director of Care and Children's Ministry at University Park United Methodist Church. Passionate about spiritual formation and caring for others, she has dedicated her ministry to helping people grow in faith and connection." podcast="../public/audio/bethany_podcast.mp3" className="orange-person"/>
