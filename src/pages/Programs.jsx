...
function Programs() {
    ...
    return (
        ...
        <img id="cnp" className="programs-img" src={`${import.meta.env.BASE_URL}/images/programs/CNP.png`} />
        ...
        <div className="people-section">
            <Person id="jon" photo={`${import.meta.env.BASE_URL}/images/headshots/Jon.jpg`} name="Jon Shockness" description="Jon Shockness is a creative artist known by the names Neon Wolf and Kid Astronaut. He is also the founder of GARDEN, a mobile food pantry focused on advancing food justice by delivering food directly to places where people already gather." podcast={`${import.meta.env.BASE_URL}/audio/jon_podcast.mp3`} podcast2={`${import.meta.env.BASE_URL}/audio/jon_podcast_2.mp3`} className="orange-person"/>
            <Person id="bethany" photo={`${import.meta.env.BASE_URL}/images/headshots/Bethany.png`} name="Bethany Hader Crabbs" description="Bethany Hader Crabbs serves as the Director of Care and Children's Ministry at University Park United Methodist Church. Passionate about spiritual formation and caring for others, she has dedicated her ministry to helping people grow in faith and connection." podcast={`${import.meta.env.BASE_URL}/audio/bethany_podcast.mp3`} className="orange-person"/>
            <Person photo={`${import.meta.env.BASE_URL}/images/headshots/Nate.png`} name="Nate Preisinger" description="Nate Preisinger is a pastor at Bethany Lutheran Church and serves on the board. He also played a key role in creating the Bethany Lutheran podcast studio, helping expand opportunities for meaningful conversations." podcast={`${import.meta.env.BASE_URL}/audio/nate_podcast.mp3`} podcast2={`${import.meta.env.BASE_URL}/audio/nate_podcast_2.mp3`} className="orange-person"/>
            <Person photo={`${import.meta.env.BASE_URL}/images/headshots/Epignosis.jpg`} name="Epignosis" description="Epignosis is a graduate student in the Health Informatics program at the University of Denver and originally from Ghana in West Africa. His work and studies explore the ways technology can improve healthcare systems and outcomes." podcast={`${import.meta.env.BASE_URL}/audio/epignosis_podcast.mp3`} podcast2={`${import.meta.env.BASE_URL}/audio/epignosis_podcast_2.mp3`} className="orange-person"/>
            <Person id="gabbi" photo={`${import.meta.env.BASE_URL}/images/headshots/Gabbi.JPG`} name="Gabbi Ohaya" description="Gabrielle &quot;Gabbi&quot; Ohaya is a Denver native, educator, entrepreneur, and community builder whose work is rooted in food justice and neighborhood connection. After careers in education, nonprofit leadership, business development, and the food industry, she co-founded FaithFull Food, where she serves as Director of Business Development. Gabbi is passionate about creating opportunities that bring people together through food, partnership, and joyful community." podcast={`${import.meta.env.BASE_URL}/audio/gabbi_podcast.mp3`} className="orange-person"/>
            <Person id="embra" photo={`${import.meta.env.BASE_URL}/images/headshots/Embra.png`} name="Embra Daylie" description="Embra Daylie has been a member of University Park United Methodist Church for more than two decades and has long been committed to strengthening communities through food and service. Inspired by his work with Agape and alongside Carolyn Tarr, he helped launch a community grow program that fostered connection and shared purpose. Today, he co-leads FaithFull Food, continuing to cultivate partnerships that nourish both people and neighborhoods." podcast={`${import.meta.env.BASE_URL}/audio/embra_podcast.mp3`} className="orange-person"/>
        </div>
        {/* DO FOOD */}
        <img id="do-food" src={`${import.meta.env.BASE_URL}images/programs/do-food.png`} className="programs-img do-food" />
        ...
        <div id="do-food-gallery">
            <img key={media} className="gallery-media" src={`${import.meta.env.BASE_URL}` + gallery_media[media]} />
        ...
        <img id="cornerstone" src={`${import.meta.env.BASE_URL}images/programs/book/cover.png`} className="programs-img" />
        ...
        {/* book */}
        <div id="book-wrapper">
            <img id="rings" src={`${import.meta.env.BASE_URL}/images/programs/book/rings.png`}></img>
            <div onClick={flipPage} id="programs-book">
                <img key={page} className="book-page" src={`${import.meta.env.BASE_URL}/images/programs/book/` + book_images[page]} />
            </div>
        </div>
        {/* HYDROPONICS */}
